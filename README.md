...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/notion-client-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14620&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/notion-client-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `notion-client` can be installed with:

```
conda install notion-client
```

It is possible to list all of the versions of `notion-client` available on your platform with:
